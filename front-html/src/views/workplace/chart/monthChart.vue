    ...
    export default {
        ...
        methods: {
            ...
            handleDatePicker(value) {
                let startTime = dayjs(value).startOf('month').format('YYYY-MM-DD');
                let endTime = dayjs(value).endOf('month').format('YYYY-MM-DD');
                console.log(startTime, endTime)
                // 向后端发请求
                chartApi.getChartData(startTime, endTime, chartType.line, 'month').then(res => {
        ...
        created() {
            this.datePickerValue = dayjs().format("YYYY-MM");
